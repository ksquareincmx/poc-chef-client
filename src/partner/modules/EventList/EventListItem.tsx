    ...
    >
      ...
      >
        ...
        <div className="event-row-data" style={styles.rowData}>
          <p className="event-date event-row-item" style={styles.eventRowItem}>
            27/07/2018
          </p>
          <p className="event-time event-row-item" style={styles.eventRowItem}>
            5:00 PM - 12:00 AM
          </p>
        </div>
      </div>
      ...
      >
        <table style={styles.rowDataContainer}>
          <thead style={styles.rowDataContainer}>
            <tr>
              <th>
                <h2 style={{ ...styles.h2, textAlign: "left" }}>Tortas</h2>
              </th>
              <th>
                <h2 style={{ ...styles.h2, textAlign: "center" }}>Price</h2>
              </th>
              <th>
                <h2 style={{ ...styles.h2, textAlign: "center" }}>Units</h2>
              </th>
              <th>
                <h2 style={{ ...styles.h2, textAlign: "right" }}>Amount</h2>
              </th>
            </tr>
          </thead>
          <tbody>
          ...
          <tfoot>
            <tr>
              <td>
                <h2 style={{ ...styles.h2, textAlign: "left" }}>Total</h2>
              </td>
              <td />
              <td />
              <td>
